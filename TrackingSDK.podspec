...
#s.pod_target_xcconfig = { 'SWIFT_VERSION' => '4.0.3' }
  ...
  s.author             = { "Ramesh" => "ramesh.softprodigy@gmail.com" }
  # Or just: s.author    = "Ramesh"
  # s.authors            = { "Ramesh" => "ramesh.softprodigy@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/softprodigyofficial/TrackingSDK.git", :tag => "0.0.3" }
